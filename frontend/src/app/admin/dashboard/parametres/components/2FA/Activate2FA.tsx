    ...
    return (
        <>
            ...
            <Dialog open={showLoginDialog} onOpenChange={setShowLoginDialog}>
                ...
                {/* Login Dialog */}
                <LoginDialog onLoginSuccess={handleLoginSuccess} reason="activer la double authentification"/>
            </Dialog>

            {/* QR Code Dialog */}
            <Dialog open={showQrCodeDialog} onOpenChange={setShowQrCodeDialog}>
                <Init2FA showQrCodeDialog={showQrCodeDialog} onInitSuccess={handleInitSuccess} />
            </Dialog>

            {/* Success Dialog */}
            <Dialog open={showInitSuccess2FA} onOpenChange={setShowInitSuccess2FA}>
                <InitSuccess2FA backupCodes={backupCodes} onUpdate={() => onUpdate(true)} />
            </Dialog>
        </>
    );
};
